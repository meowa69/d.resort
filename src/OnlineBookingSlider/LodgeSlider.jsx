...
const LodgeSlider = () => {
    const cards = [
        { id: 1, imgSrc: "./src/assets/sample5.jpg", title: "Card Title 1", description: "Description 1" },
        { id: 2, imgSrc: "./src/assets/sample4.jpg", title: "Card Title 2", description: "Description 2" },
        { id: 3, imgSrc: "./src/assets/sample3.jpg", title: "Card Title 3", description: "Description 3" },
        { id: 4, imgSrc: "./src/assets/sample2.jpg", title: "Card Title 4", description: "Description 4" },
        { id: 5, imgSrc: "./src/assets/sample1.jpg", title: "Card Title 5", description: "Description 5" },
    ];
                    ...
                    <div key={card.id} className="flex-shrink-0 w-full md:w-1/3 p-2">
                        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div className="p-4">
                                ...
                                <button className="shadow-sm bg-[#09B0EF] hover:bg-[#3fbae7] text-white font-semibold px-4 py-2 rounded-md">
                                    Learn More
                                </button>
                            </div>
                        </div>
