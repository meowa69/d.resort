...
const CottageSlider = () => {
    const cards = [
        { id: 1, imgSrc: "./src/assets/sample1.jpg", title: "Card Title 1", description: "Full Description 1" },
        { id: 2, imgSrc: "./src/assets/sample2.jpg", title: "Card Title 2", description: "Full Description 2" },
        { id: 3, imgSrc: "./src/assets/sample3.jpg", title: "Card Title 3", description: "Full Description 3" },
        { id: 4, imgSrc: "./src/assets/sample4.jpg", title: "Card Title 4", description: "Full Description 4" },
        { id: 5, imgSrc: "./src/assets/sample5.jpg", title: "Card Title 5", description: "Full Description 5" },
    ];

    const cardsToShow = 3;
    const [currentIndex, setCurrentIndex] = useState(0);
    const [showModal, setShowModal] = useState(false);
    const [selectedCard, setSelectedCard] = useState(null); // For the selected card's data
                        ...
                        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div className="p-4">
                                ...
                                <button 
                                    ...
                                    onClick={() => handleView(card)} // Pass card data to the view handler
                                >
                                    View
                                </button>
                            </div>
